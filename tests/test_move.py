...
def test_polartorect1():
    robot1 = Robot((0, 0), 0)
    res = robot1._polar_to_rect(270, 100, (0, 0))
    assert res == (0, 0)


def test_polartorect2():
    robot1 = Robot((0, 0), 0)
    res = robot1._polar_to_rect(180 + 45, 999, (200, 400))
    assert res == (0, 200)


def test_polartorect3():
    robot1 = Robot((0, 0), 0)
    res = robot1._polar_to_rect(179, 200, (100, 500))
    assert res == (0, 501)


def test_polartorect4():
    robot1 = Robot((0, 0), 0)
    res = robot1._polar_to_rect(30, 999, (100, 500))
    assert res == (965, 999)
