...
def test_shoot_in_table():
    obj1 = obj1 = Robot(position=(5, 10), damage=100, direction=45, velocity=100)
    obj1.cannon(45, 200)
    result = obj1.shoot()
...
def test_random_in_range_2():
    obj1 = obj1 = Robot(position=(950, 980), damage=100, direction=45, velocity=100)
    tup_test = (random.randint(0, 360), random.randint(0, 700))
    obj1.cannon(tup_test[0], tup_test[1])
    print("T2")
    print("Position -> ", obj1.current_position)
...
def test_random_in_range_7():
    obj1 = obj1 = Robot(position=(5, 990), damage=100, direction=45, velocity=100)
    tup_test = (random.randint(0, 360), random.randint(0, 700))
    obj1.cannon(tup_test[0], tup_test[1])
    print("T7")
    print("Position -> ", obj1.current_position)
...
def test_random_in_range_8():
    obj1 = obj1 = Robot(position=(990, 5), damage=100, direction=45, velocity=100)
    tup_test = (random.randint(0, 360), random.randint(0, 700))
    obj1.cannon(tup_test[0], tup_test[1])
    print("T8")
    print("Position -> ", obj1.current_position)
